...
files = [
    ("Current-only FGO", "results/result_case1.csv"),
    ("Linear Voltage FGO", "results/result_case1_voltage_fgo.csv"),
    ("Nonlinear Voltage FGO", "results/result_case1_nonlinear_voltage_fgo.csv"),
]
