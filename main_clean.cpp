...
int main() {
    ...
    const double ocv0 = 3.0;
    const double ocv_slope = 1.2;
    ...
    for (size_t i = 0; i < N; ++i) {
        graph.emplace_shared<SOCVoltageFactor>(
            Symbol('x', i),
            voltage[i],
            current[i],
            ocv0,
    ...
    cout << "Voltage-constrained FGO estimation DONE!" << endl;
