...
files = [
    ("Noise005 Linear Voltage FGO", "results/result_random_linear_voltage_noise005.csv"),
    ("Noise005 Nonlinear Voltage FGO", "results/result_random_nonlinear_voltage_noise005.csv"),
]
